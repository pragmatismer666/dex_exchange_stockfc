...
import Token6201 from '../tokens/Token6201.json'
import Exchange6201 from '../exchanges/Exchange6201.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token6201.abi, Token6201.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange6201.abi, Exchange6201.networks[networkId].address)
