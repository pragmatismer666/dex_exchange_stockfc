...
import Token1094 from '../tokens/Token1094.json'
import Exchange1094 from '../exchanges/Exchange1094.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1094.abi, Token1094.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1094.abi, Exchange1094.networks[networkId].address)
