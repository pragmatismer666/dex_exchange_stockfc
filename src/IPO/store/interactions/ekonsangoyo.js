...
import Token7124 from '../tokens/Token7124.json'
import Exchange7124 from '../exchanges/Exchange7124.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token7124.abi, Token7124.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange7124.abi, Exchange7124.networks[networkId].address)
