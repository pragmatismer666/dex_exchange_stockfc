...
import Token1387 from '../tokens/Token1387.json'
import Exchange1387 from '../exchanges/Exchange1387.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1387.abi, Token1387.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1387.abi, Exchange1387.networks[networkId].address)
