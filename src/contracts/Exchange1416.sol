...
contract Exchange1416 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1416(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1416(_token).transfer(msg.sender, _amount));
