...
contract Exchange73906 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token73906(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token73906(_token).transfer(msg.sender, _amount));
