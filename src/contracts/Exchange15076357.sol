...
contract Exchange15076357 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token15076357(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token15076357(_token).transfer(msg.sender, _amount));
