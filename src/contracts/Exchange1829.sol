...
contract Exchange1829 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1829(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1829(_token).transfer(msg.sender, _amount));
