...
contract Exchange7958 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token7958(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token7958(_token).transfer(msg.sender, _amount));
