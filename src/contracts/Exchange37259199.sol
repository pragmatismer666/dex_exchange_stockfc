...
contract Exchange37259199 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token37259199(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token37259199(_token).transfer(msg.sender, _amount));
