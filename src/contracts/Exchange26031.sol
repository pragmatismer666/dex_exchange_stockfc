...
contract Exchange26031 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token26031(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token26031(_token).transfer(msg.sender, _amount));
