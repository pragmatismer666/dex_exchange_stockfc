...
contract Exchange164061 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token164061(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token164061(_token).transfer(msg.sender, _amount));
