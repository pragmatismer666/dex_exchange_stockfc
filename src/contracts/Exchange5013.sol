...
contract Exchange5013 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token5013(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token5013(_token).transfer(msg.sender, _amount));
