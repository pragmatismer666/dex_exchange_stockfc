...
contract Exchange1572 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1572(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1572(_token).transfer(msg.sender, _amount));
