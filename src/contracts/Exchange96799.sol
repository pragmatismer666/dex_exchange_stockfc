...
contract Exchange96799 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token96799(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token96799(_token).transfer(msg.sender, _amount));
