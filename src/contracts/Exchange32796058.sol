...
contract Exchange32796058 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token32796058(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token32796058(_token).transfer(msg.sender, _amount));
