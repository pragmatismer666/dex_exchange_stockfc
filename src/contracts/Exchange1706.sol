...
contract Exchange1706 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1706(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1706(_token).transfer(msg.sender, _amount));
