...
contract Exchange96426 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token96426(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token96426(_token).transfer(msg.sender, _amount));
