...
contract Exchange1791 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1791(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1791(_token).transfer(msg.sender, _amount));
