...
contract Exchange96088 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token96088(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token96088(_token).transfer(msg.sender, _amount));
