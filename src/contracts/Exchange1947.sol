...
contract Exchange1947 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1947(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1947(_token).transfer(msg.sender, _amount));
