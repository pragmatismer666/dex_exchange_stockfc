...
contract Exchange1692 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1692(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1692(_token).transfer(msg.sender, _amount));
