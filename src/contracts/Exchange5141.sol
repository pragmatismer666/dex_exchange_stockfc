...
contract Exchange5141 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token5141(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token5141(_token).transfer(msg.sender, _amount));
