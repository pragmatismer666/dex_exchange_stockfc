...
contract Exchange32404895 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token32404895(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token32404895(_token).transfer(msg.sender, _amount));
