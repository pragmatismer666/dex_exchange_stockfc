...
contract Exchange1452 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1452(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1452(_token).transfer(msg.sender, _amount));
