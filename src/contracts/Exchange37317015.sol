...
contract Exchange37317015 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token37317015(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token37317015(_token).transfer(msg.sender, _amount));
