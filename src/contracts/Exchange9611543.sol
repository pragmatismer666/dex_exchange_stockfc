...
contract Exchange9611543 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token9611543(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token9611543(_token).transfer(msg.sender, _amount));
