...
contract Exchange130177 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token130177(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token130177(_token).transfer(msg.sender, _amount));
