...
contract Exchange1387 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1387(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1387(_token).transfer(msg.sender, _amount));
