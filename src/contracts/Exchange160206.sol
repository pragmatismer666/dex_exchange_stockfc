...
contract Exchange160206 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token160206(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token160206(_token).transfer(msg.sender, _amount));
