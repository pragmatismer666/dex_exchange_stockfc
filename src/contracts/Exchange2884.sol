...
contract Exchange2884 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token2884(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token2884(_token).transfer(msg.sender, _amount));
