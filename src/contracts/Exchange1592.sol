...
contract Exchange1592 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1592(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1592(_token).transfer(msg.sender, _amount));
