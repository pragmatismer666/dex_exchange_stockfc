...
contract Exchange4371 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token4371(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token4371(_token).transfer(msg.sender, _amount));
