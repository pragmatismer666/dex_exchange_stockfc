...
contract Exchange12647 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token12647(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token12647(_token).transfer(msg.sender, _amount));
