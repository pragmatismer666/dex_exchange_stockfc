...
contract Exchange129245 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token129245(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token129245(_token).transfer(msg.sender, _amount));
