...
contract Exchange82032 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token82032(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token82032(_token).transfer(msg.sender, _amount));
