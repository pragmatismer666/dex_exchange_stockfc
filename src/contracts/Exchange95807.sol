...
contract Exchange95807 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token95807(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token95807(_token).transfer(msg.sender, _amount));
