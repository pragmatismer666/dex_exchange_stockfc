...
contract Exchange1881 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1881(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1881(_token).transfer(msg.sender, _amount));
