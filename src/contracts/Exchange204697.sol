...
contract Exchange204697 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token204697(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token204697(_token).transfer(msg.sender, _amount));
