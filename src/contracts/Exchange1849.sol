...
contract Exchange1849 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1849(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1849(_token).transfer(msg.sender, _amount));
