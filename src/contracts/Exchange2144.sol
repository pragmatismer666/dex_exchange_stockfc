...
contract Exchange2144 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token2144(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token2144(_token).transfer(msg.sender, _amount));
