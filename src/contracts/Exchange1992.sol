...
contract Exchange1992 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1992(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1992(_token).transfer(msg.sender, _amount));
