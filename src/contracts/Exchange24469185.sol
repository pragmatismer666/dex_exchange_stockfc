...
contract Exchange24469185 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token24469185(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token24469185(_token).transfer(msg.sender, _amount));
