...
contract Exchange12759176 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token12759176(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token12759176(_token).transfer(msg.sender, _amount));
