...
contract Exchange37316858 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token37316858(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token37316858(_token).transfer(msg.sender, _amount));
