...
contract Exchange455376 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token455376(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token455376(_token).transfer(msg.sender, _amount));
