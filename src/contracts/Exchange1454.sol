...
contract Exchange1454 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1454(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1454(_token).transfer(msg.sender, _amount));
