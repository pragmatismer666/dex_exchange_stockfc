...
contract Exchange32421 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token32421(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token32421(_token).transfer(msg.sender, _amount));
