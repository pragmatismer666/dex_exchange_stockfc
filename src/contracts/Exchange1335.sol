...
contract Exchange1335 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1335(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1335(_token).transfer(msg.sender, _amount));
