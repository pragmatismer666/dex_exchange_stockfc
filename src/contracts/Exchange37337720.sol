...
contract Exchange37337720 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token37337720(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token37337720(_token).transfer(msg.sender, _amount));
