...
contract Exchange12433159 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token12433159(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token12433159(_token).transfer(msg.sender, _amount));
