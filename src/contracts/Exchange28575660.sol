...
contract Exchange28575660 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token28575660(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token28575660(_token).transfer(msg.sender, _amount));
