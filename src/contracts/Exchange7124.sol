...
contract Exchange7124 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token7124(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token7124(_token).transfer(msg.sender, _amount));
