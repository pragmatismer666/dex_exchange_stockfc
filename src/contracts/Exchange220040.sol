...
contract Exchange220040 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token220040(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token220040(_token).transfer(msg.sender, _amount));
