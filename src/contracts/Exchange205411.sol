...
contract Exchange205411 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token205411(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token205411(_token).transfer(msg.sender, _amount));
