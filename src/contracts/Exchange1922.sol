...
contract Exchange1922 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1922(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1922(_token).transfer(msg.sender, _amount));
