...
contract Exchange1651 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1651(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1651(_token).transfer(msg.sender, _amount));
