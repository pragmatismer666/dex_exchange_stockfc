...
contract Exchange37356242 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token37356242(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token37356242(_token).transfer(msg.sender, _amount));
