...
contract Exchange219633 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token219633(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token219633(_token).transfer(msg.sender, _amount));
