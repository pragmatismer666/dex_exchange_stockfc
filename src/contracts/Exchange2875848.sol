...
contract Exchange2875848 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token2875848(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token2875848(_token).transfer(msg.sender, _amount));
