...
contract Exchange31626620 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token31626620(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token31626620(_token).transfer(msg.sender, _amount));
