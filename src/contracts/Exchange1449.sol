...
contract Exchange1449 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1449(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1449(_token).transfer(msg.sender, _amount));
