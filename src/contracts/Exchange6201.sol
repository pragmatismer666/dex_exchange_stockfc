...
contract Exchange6201 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token6201(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token6201(_token).transfer(msg.sender, _amount));
