...
contract Exchange80655 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token80655(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token80655(_token).transfer(msg.sender, _amount));
