...
contract Exchange28912805 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token28912805(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token28912805(_token).transfer(msg.sender, _amount));
