...
contract Exchange1826 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1826(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1826(_token).transfer(msg.sender, _amount));
