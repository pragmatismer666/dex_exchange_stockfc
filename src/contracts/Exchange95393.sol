...
contract Exchange95393 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token95393(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token95393(_token).transfer(msg.sender, _amount));
