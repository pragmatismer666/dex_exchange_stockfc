...
contract Exchange1261 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1261(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1261(_token).transfer(msg.sender, _amount));
