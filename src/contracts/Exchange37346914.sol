...
contract Exchange37346914 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token37346914(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token37346914(_token).transfer(msg.sender, _amount));
