...
contract Exchange5252 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token5252(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token5252(_token).transfer(msg.sender, _amount));
