...
contract Exchange1941 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1941(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1941(_token).transfer(msg.sender, _amount));
