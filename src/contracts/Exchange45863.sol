...
contract Exchange45863 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token45863(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token45863(_token).transfer(msg.sender, _amount));
