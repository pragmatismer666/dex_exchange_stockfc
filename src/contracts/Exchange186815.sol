...
contract Exchange186815 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token186815(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token186815(_token).transfer(msg.sender, _amount));
