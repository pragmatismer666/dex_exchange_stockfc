...
contract Exchange28912855 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token28912855(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token28912855(_token).transfer(msg.sender, _amount));
