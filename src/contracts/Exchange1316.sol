...
contract Exchange1316 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1316(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1316(_token).transfer(msg.sender, _amount));
