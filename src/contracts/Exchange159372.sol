...
contract Exchange159372 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token159372(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token159372(_token).transfer(msg.sender, _amount));
