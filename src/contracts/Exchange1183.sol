...
contract Exchange1183 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1183(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1183(_token).transfer(msg.sender, _amount));
