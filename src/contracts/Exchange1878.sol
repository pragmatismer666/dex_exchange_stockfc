...
contract Exchange1878 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1878(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1878(_token).transfer(msg.sender, _amount));
