...
contract Exchange538034 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token538034(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token538034(_token).transfer(msg.sender, _amount));
