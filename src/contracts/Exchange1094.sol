...
contract Exchange1094 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1094(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1094(_token).transfer(msg.sender, _amount));
