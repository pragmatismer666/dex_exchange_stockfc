...
contract Exchange581199 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token581199(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token581199(_token).transfer(msg.sender, _amount));
