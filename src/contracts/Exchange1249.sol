...
contract Exchange1249 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token1249(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token1249(_token).transfer(msg.sender, _amount));
