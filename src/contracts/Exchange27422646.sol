...
contract Exchange27422646 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token27422646(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token27422646(_token).transfer(msg.sender, _amount));
