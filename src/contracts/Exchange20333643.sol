...
contract Exchange20333643 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token20333643(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token20333643(_token).transfer(msg.sender, _amount));
