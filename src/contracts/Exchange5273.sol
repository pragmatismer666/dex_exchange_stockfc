...
contract Exchange5273 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token5273(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token5273(_token).transfer(msg.sender, _amount));
