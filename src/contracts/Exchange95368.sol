...
contract Exchange95368 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token95368(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token95368(_token).transfer(msg.sender, _amount));
