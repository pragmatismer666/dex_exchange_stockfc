...
contract Exchange129602 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token129602(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token129602(_token).transfer(msg.sender, _amount));
