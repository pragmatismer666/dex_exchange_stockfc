...
contract Exchange3544 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token3544(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token3544(_token).transfer(msg.sender, _amount));
