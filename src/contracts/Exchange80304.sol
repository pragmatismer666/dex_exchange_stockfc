...
contract Exchange80304 {
  ...
  function depositToken(address _token, uint _amount) public {
    ...
    require(Token80304(_token).transferFrom(msg.sender, address(this), _amount));
 ...
 require(Token80304(_token).transfer(msg.sender, _amount));
