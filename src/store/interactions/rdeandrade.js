...
import Token219633 from '../tokens/Token219633.json'
import Exchange219633 from '../exchanges/Exchange219633.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token219633.abi, Token219633.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange219633.abi, Exchange219633.networks[networkId].address)
