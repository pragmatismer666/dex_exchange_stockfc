...
import Token220040 from '../tokens/Token220040.json'
import Exchange220040 from '../exchanges/Exchange220040.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token220040.abi, Token220040.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange220040.abi, Exchange220040.networks[networkId].address)
