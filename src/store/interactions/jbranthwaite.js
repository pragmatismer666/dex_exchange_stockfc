...
import Token32404895 from '../tokens/Token32404895.json'
import Exchange32404895 from '../exchanges/Exchange32404895.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token32404895.abi, Token32404895.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange32404895.abi, Exchange32404895.networks[networkId].address)
