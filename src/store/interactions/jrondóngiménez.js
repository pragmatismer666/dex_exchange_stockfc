...
import Token1651 from '../tokens/Token1651.json'
import Exchange1651 from '../exchanges/Exchange1651.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1651.abi, Token1651.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1651.abi, Exchange1651.networks[networkId].address)
