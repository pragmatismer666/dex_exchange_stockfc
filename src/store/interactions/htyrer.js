...
import Token28575660 from '../tokens/Token28575660.json'
import Exchange28575660 from '../exchanges/Exchange28575660.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token28575660.abi, Token28575660.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange28575660.abi, Exchange28575660.networks[networkId].address)
