...
import Token28912805 from '../tokens/Token28912805.json'
import Exchange28912805 from '../exchanges/Exchange28912805.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token28912805.abi, Token28912805.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange28912805.abi, Exchange28912805.networks[networkId].address)
