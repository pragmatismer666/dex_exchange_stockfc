...
import Token1947 from '../tokens/Token1947.json'
import Exchange1947 from '../exchanges/Exchange1947.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1947.abi, Token1947.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1947.abi, Exchange1947.networks[networkId].address)
