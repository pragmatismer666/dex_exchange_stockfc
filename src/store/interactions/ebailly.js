...
import Token1849 from '../tokens/Token1849.json'
import Exchange1849 from '../exchanges/Exchange1849.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1849.abi, Token1849.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1849.abi, Exchange1849.networks[networkId].address)
