...
import Token20333643 from '../tokens/Token20333643.json'
import Exchange20333643 from '../exchanges/Exchange20333643.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token20333643.abi, Token20333643.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange20333643.abi, Exchange20333643.networks[networkId].address)
