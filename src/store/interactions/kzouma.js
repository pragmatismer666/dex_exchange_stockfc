...
import Token1316 from '../tokens/Token1316.json'
import Exchange1316 from '../exchanges/Exchange1316.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1316.abi, Token1316.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1316.abi, Exchange1316.networks[networkId].address)
