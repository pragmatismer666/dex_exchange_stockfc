...
import Token1335 from '../tokens/Token1335.json'
import Exchange1335 from '../exchanges/Exchange1335.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1335.abi, Token1335.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1335.abi, Exchange1335.networks[networkId].address)
