...
import Token156 from '../tokens/Token156.json'
import Exchange156 from '../exchanges/Exchange156.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token156.abi, Token156.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange156.abi, Exchange156.networks[networkId].address)
