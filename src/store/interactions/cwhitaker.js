...
import Token37356242 from '../tokens/Token37356242.json'
import Exchange37356242 from '../exchanges/Exchange37356242.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token37356242.abi, Token37356242.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange37356242.abi, Exchange37356242.networks[networkId].address)
