...
import Token7958 from '../tokens/Token7958.json'
import Exchange7958 from '../exchanges/Exchange7958.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token7958.abi, Token7958.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange7958.abi, Exchange7958.networks[networkId].address)
