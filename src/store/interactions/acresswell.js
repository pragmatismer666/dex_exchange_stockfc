...
import Token1261 from '../tokens/Token1261.json'
import Exchange1261 from '../exchanges/Exchange1261.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1261.abi, Token1261.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1261.abi, Exchange1261.networks[networkId].address)
