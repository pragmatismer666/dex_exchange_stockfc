...
import Token1922 from '../tokens/Token1922.json'
import Exchange1922 from '../exchanges/Exchange1922.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1922.abi, Token1922.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1922.abi, Exchange1922.networks[networkId].address)
