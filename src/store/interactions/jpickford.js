...
import Token1826 from '../tokens/Token1826.json'
import Exchange1826 from '../exchanges/Exchange1826.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1826.abi, Token1826.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1826.abi, Exchange1826.networks[networkId].address)
