...
import Token28912855 from '../tokens/Token28912855.json'
import Exchange28912855 from '../exchanges/Exchange28912855.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token28912855.abi, Token28912855.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange28912855.abi, Exchange28912855.networks[networkId].address)
