...
import Token15076357 from '../tokens/Token15076357.json'
import Exchange15076357 from '../exchanges/Exchange15076357.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token15076357.abi, Token15076357.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange15076357.abi, Exchange15076357.networks[networkId].address)
