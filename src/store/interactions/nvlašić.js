...
import Token73906 from '../tokens/Token73906.json'
import Exchange73906 from '../exchanges/Exchange73906.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token73906.abi, Token73906.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange73906.abi, Exchange73906.networks[networkId].address)
