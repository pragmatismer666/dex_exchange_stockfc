...
import Token37346914 from '../tokens/Token37346914.json'
import Exchange37346914 from '../exchanges/Exchange37346914.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token37346914.abi, Token37346914.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange37346914.abi, Exchange37346914.networks[networkId].address)
