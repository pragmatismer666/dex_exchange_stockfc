...
import Token832 from '../tokens/Token832.json'
import Exchange832 from '../exchanges/Exchange832.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token832.abi, Token832.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange832.abi, Exchange832.networks[networkId].address)
