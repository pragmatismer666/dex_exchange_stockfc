...
import Token957 from '../tokens/Token957.json'
import Exchange957 from '../exchanges/Exchange957.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token957.abi, Token957.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange957.abi, Exchange957.networks[networkId].address)
