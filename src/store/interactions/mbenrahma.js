...
import Token96426 from '../tokens/Token96426.json'
import Exchange96426 from '../exchanges/Exchange96426.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token96426.abi, Token96426.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange96426.abi, Exchange96426.networks[networkId].address)
