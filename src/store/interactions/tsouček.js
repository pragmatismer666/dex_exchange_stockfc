...
import Token80655 from '../tokens/Token80655.json'
import Exchange80655 from '../exchanges/Exchange80655.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token80655.abi, Token80655.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange80655.abi, Exchange80655.networks[networkId].address)
