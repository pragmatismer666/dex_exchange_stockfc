...
import Token82032 from '../tokens/Token82032.json'
import Exchange82032 from '../exchanges/Exchange82032.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token82032.abi, Token82032.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange82032.abi, Exchange82032.networks[networkId].address)
