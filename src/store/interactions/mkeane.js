...
import Token881 from '../tokens/Token881.json'
import Exchange881 from '../exchanges/Exchange881.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token881.abi, Token881.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange881.abi, Exchange881.networks[networkId].address)
