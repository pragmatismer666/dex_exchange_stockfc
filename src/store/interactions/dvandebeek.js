...
import Token26031 from '../tokens/Token26031.json'
import Exchange26031 from '../exchanges/Exchange26031.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token26031.abi, Token26031.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange26031.abi, Exchange26031.networks[networkId].address)
