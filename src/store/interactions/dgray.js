...
import Token1572 from '../tokens/Token1572.json'
import Exchange1572 from '../exchanges/Exchange1572.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1572.abi, Token1572.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1572.abi, Exchange1572.networks[networkId].address)
