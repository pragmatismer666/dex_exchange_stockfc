...
import Token1592 from '../tokens/Token1592.json'
import Exchange1592 from '../exchanges/Exchange1592.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1592.abi, Token1592.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1592.abi, Exchange1592.networks[networkId].address)
