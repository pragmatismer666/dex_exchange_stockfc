...
import Token160206 from '../tokens/Token160206.json'
import Exchange160206 from '../exchanges/Exchange160206.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token160206.abi, Token160206.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange160206.abi, Exchange160206.networks[networkId].address)
