...
import Token1829 from '../tokens/Token1829.json'
import Exchange1829 from '../exchanges/Exchange1829.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1829.abi, Token1829.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1829.abi, Exchange1829.networks[networkId].address)
