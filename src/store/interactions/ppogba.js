...
import Token1992 from '../tokens/Token1992.json'
import Exchange1992 from '../exchanges/Exchange1992.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1992.abi, Token1992.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1992.abi, Exchange1992.networks[networkId].address)
