...
import Token383 from '../tokens/Token383.json'
import Exchange383 from '../exchanges/Exchange383.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token383.abi, Token383.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange383.abi, Exchange383.networks[networkId].address)
