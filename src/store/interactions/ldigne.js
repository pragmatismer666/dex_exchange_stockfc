...
import Token95368 from '../tokens/Token95368.json'
import Exchange95368 from '../exchanges/Exchange95368.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token95368.abi, Token95368.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange95368.abi, Exchange95368.networks[networkId].address)
