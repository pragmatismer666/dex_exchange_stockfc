...
import Token1249 from '../tokens/Token1249.json'
import Exchange1249 from '../exchanges/Exchange1249.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1249.abi, Token1249.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1249.abi, Exchange1249.networks[networkId].address)
