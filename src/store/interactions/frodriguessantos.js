...
import Token205411 from '../tokens/Token205411.json'
import Exchange205411 from '../exchanges/Exchange205411.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token205411.abi, Token205411.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange205411.abi, Exchange205411.networks[networkId].address)
