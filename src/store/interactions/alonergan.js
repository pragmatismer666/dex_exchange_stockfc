...
import Token1791 from '../tokens/Token1791.json'
import Exchange1791 from '../exchanges/Exchange1791.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1791.abi, Token1791.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1791.abi, Exchange1791.networks[networkId].address)
