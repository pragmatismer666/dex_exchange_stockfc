...
import Token764 from '../tokens/Token764.json'
import Exchange764 from '../exchanges/Exchange764.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token764.abi, Token764.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange764.abi, Exchange764.networks[networkId].address)
