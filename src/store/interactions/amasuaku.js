...
import Token1941 from '../tokens/Token1941.json'
import Exchange1941 from '../exchanges/Exchange1941.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1941.abi, Token1941.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1941.abi, Exchange1941.networks[networkId].address)
