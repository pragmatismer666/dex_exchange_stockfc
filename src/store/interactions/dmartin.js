...
import Token3544 from '../tokens/Token3544.json'
import Exchange3544 from '../exchanges/Exchange3544.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token3544.abi, Token3544.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange3544.abi, Exchange3544.networks[networkId].address)
