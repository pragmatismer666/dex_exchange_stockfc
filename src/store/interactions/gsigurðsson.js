...
import Token814 from '../tokens/Token814.json'
import Exchange814 from '../exchanges/Exchange814.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token814.abi, Token814.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange814.abi, Exchange814.networks[networkId].address)
