...
import Token5273 from '../tokens/Token5273.json'
import Exchange5273 from '../exchanges/Exchange5273.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token5273.abi, Token5273.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange5273.abi, Exchange5273.networks[networkId].address)
