...
import Token204697 from '../tokens/Token204697.json'
import Exchange204697 from '../exchanges/Exchange204697.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token204697.abi, Token204697.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange204697.abi, Exchange204697.networks[networkId].address)
