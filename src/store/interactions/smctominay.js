...
import Token455376 from '../tokens/Token455376.json'
import Exchange455376 from '../exchanges/Exchange455376.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token455376.abi, Token455376.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange455376.abi, Exchange455376.networks[networkId].address)
