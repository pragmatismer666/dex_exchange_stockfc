...
import Token2875848 from '../tokens/Token2875848.json'
import Exchange2875848 from '../exchanges/Exchange2875848.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token2875848.abi, Token2875848.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange2875848.abi, Exchange2875848.networks[networkId].address)
