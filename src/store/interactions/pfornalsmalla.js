...
import Token186815 from '../tokens/Token186815.json'
import Exchange186815 from '../exchanges/Exchange186815.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token186815.abi, Token186815.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange186815.abi, Exchange186815.networks[networkId].address)
