...
import Token32421 from '../tokens/Token32421.json'
import Exchange32421 from '../exchanges/Exchange32421.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token32421.abi, Token32421.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange32421.abi, Exchange32421.networks[networkId].address)
