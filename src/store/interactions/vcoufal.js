...
import Token80304 from '../tokens/Token80304.json'
import Exchange80304 from '../exchanges/Exchange80304.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token80304.abi, Token80304.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange80304.abi, Exchange80304.networks[networkId].address)
