...
import Token1449 from '../tokens/Token1449.json'
import Exchange1449 from '../exchanges/Exchange1449.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1449.abi, Token1449.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1449.abi, Exchange1449.networks[networkId].address)
