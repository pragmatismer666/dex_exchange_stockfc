...
import Token96088 from '../tokens/Token96088.json'
import Exchange96088 from '../exchanges/Exchange96088.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token96088.abi, Token96088.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange96088.abi, Exchange96088.networks[networkId].address)
