...
import Token1416 from '../tokens/Token1416.json'
import Exchange1416 from '../exchanges/Exchange1416.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1416.abi, Token1416.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1416.abi, Exchange1416.networks[networkId].address)
