...
import Token96799 from '../tokens/Token96799.json'
import Exchange96799 from '../exchanges/Exchange96799.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token96799.abi, Token96799.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange96799.abi, Exchange96799.networks[networkId].address)
