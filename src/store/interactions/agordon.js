...
import Token9611543 from '../tokens/Token9611543.json'
import Exchange9611543 from '../exchanges/Exchange9611543.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token9611543.abi, Token9611543.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange9611543.abi, Exchange9611543.networks[networkId].address)
