...
import Token37316858 from '../tokens/Token37316858.json'
import Exchange37316858 from '../exchanges/Exchange37316858.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token37316858.abi, Token37316858.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange37316858.abi, Exchange37316858.networks[networkId].address)
