...
import Token433 from '../tokens/Token433.json'
import Exchange433 from '../exchanges/Exchange433.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token433.abi, Token433.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange433.abi, Exchange433.networks[networkId].address)
