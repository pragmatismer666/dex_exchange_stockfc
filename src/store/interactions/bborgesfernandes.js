...
import Token129602 from '../tokens/Token129602.json'
import Exchange129602 from '../exchanges/Exchange129602.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token129602.abi, Token129602.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange129602.abi, Exchange129602.networks[networkId].address)
