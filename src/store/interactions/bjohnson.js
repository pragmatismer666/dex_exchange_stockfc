...
import Token581199 from '../tokens/Token581199.json'
import Exchange581199 from '../exchanges/Exchange581199.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token581199.abi, Token581199.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange581199.abi, Exchange581199.networks[networkId].address)
