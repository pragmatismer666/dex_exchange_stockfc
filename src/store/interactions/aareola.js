...
import Token95393 from '../tokens/Token95393.json'
import Exchange95393 from '../exchanges/Exchange95393.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token95393.abi, Token95393.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange95393.abi, Exchange95393.networks[networkId].address)
