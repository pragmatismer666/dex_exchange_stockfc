...
import Token164061 from '../tokens/Token164061.json'
import Exchange164061 from '../exchanges/Exchange164061.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token164061.abi, Token164061.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange164061.abi, Exchange164061.networks[networkId].address)
