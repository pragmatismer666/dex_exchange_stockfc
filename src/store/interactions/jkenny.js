...
import Token5013 from '../tokens/Token5013.json'
import Exchange5013 from '../exchanges/Exchange5013.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token5013.abi, Token5013.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange5013.abi, Exchange5013.networks[networkId].address)
