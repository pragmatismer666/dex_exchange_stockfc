...
import Token95807 from '../tokens/Token95807.json'
import Exchange95807 from '../exchanges/Exchange95807.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token95807.abi, Token95807.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange95807.abi, Exchange95807.networks[networkId].address)
