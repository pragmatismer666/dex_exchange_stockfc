...
import Token955 from '../tokens/Token955.json'
import Exchange955 from '../exchanges/Exchange955.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token955.abi, Token955.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange955.abi, Exchange955.networks[networkId].address)
