...
import Token1454 from '../tokens/Token1454.json'
import Exchange1454 from '../exchanges/Exchange1454.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1454.abi, Token1454.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1454.abi, Exchange1454.networks[networkId].address)
