...
import Token681 from '../tokens/Token681.json'
import Exchange681 from '../exchanges/Exchange681.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token681.abi, Token681.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange681.abi, Exchange681.networks[networkId].address)
