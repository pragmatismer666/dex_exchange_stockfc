...
import Token159372 from '../tokens/Token159372.json'
import Exchange159372 from '../exchanges/Exchange159372.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token159372.abi, Token159372.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange159372.abi, Exchange159372.networks[networkId].address)
