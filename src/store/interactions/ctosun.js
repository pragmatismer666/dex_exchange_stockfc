...
import Token45863 from '../tokens/Token45863.json'
import Exchange45863 from '../exchanges/Exchange45863.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token45863.abi, Token45863.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange45863.abi, Exchange45863.networks[networkId].address)
