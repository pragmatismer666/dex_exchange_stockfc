...
import Token24469185 from '../tokens/Token24469185.json'
import Exchange24469185 from '../exchanges/Exchange24469185.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token24469185.abi, Token24469185.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange24469185.abi, Exchange24469185.networks[networkId].address)
