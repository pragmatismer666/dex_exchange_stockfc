...
import Token1706 from '../tokens/Token1706.json'
import Exchange1706 from '../exchanges/Exchange1706.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1706.abi, Token1706.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1706.abi, Exchange1706.networks[networkId].address)
