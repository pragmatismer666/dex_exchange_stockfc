...
import Token1183 from '../tokens/Token1183.json'
import Exchange1183 from '../exchanges/Exchange1183.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1183.abi, Token1183.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1183.abi, Exchange1183.networks[networkId].address)
