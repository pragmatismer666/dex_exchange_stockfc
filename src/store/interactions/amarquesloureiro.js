...
import Token129245 from '../tokens/Token129245.json'
import Exchange129245 from '../exchanges/Exchange129245.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token129245.abi, Token129245.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange129245.abi, Exchange129245.networks[networkId].address)
