...
import Token12647 from '../tokens/Token12647.json'
import Exchange12647 from '../exchanges/Exchange12647.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token12647.abi, Token12647.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange12647.abi, Exchange12647.networks[networkId].address)
