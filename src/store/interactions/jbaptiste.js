...
import Token37337720 from '../tokens/Token37337720.json'
import Exchange37337720 from '../exchanges/Exchange37337720.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token37337720.abi, Token37337720.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange37337720.abi, Exchange37337720.networks[networkId].address)
