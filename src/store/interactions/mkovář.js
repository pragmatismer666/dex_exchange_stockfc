...
import Token12759176 from '../tokens/Token12759176.json'
import Exchange12759176 from '../exchanges/Exchange12759176.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token12759176.abi, Token12759176.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange12759176.abi, Exchange12759176.networks[networkId].address)
