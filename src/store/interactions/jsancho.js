...
import Token538034 from '../tokens/Token538034.json'
import Exchange538034 from '../exchanges/Exchange538034.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token538034.abi, Token538034.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange538034.abi, Exchange538034.networks[networkId].address)
