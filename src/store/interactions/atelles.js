...
import Token130177 from '../tokens/Token130177.json'
import Exchange130177 from '../exchanges/Exchange130177.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token130177.abi, Token130177.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange130177.abi, Exchange130177.networks[networkId].address)
