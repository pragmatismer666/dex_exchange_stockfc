...
import Token37317015 from '../tokens/Token37317015.json'
import Exchange37317015 from '../exchanges/Exchange37317015.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token37317015.abi, Token37317015.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange37317015.abi, Exchange37317015.networks[networkId].address)
