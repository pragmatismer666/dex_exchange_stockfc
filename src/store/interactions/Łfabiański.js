...
import Token733 from '../tokens/Token733.json'
import Exchange733 from '../exchanges/Exchange733.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token733.abi, Token733.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange733.abi, Exchange733.networks[networkId].address)
