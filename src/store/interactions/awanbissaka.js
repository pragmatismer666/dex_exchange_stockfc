...
import Token5252 from '../tokens/Token5252.json'
import Exchange5252 from '../exchanges/Exchange5252.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token5252.abi, Token5252.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange5252.abi, Exchange5252.networks[networkId].address)
