...
import Token5141 from '../tokens/Token5141.json'
import Exchange5141 from '../exchanges/Exchange5141.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token5141.abi, Token5141.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange5141.abi, Exchange5141.networks[networkId].address)
