...
import Token1881 from '../tokens/Token1881.json'
import Exchange1881 from '../exchanges/Exchange1881.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1881.abi, Token1881.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1881.abi, Exchange1881.networks[networkId].address)
