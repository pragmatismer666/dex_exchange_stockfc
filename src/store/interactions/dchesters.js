...
import Token12433159 from '../tokens/Token12433159.json'
import Exchange12433159 from '../exchanges/Exchange12433159.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token12433159.abi, Token12433159.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange12433159.abi, Exchange12433159.networks[networkId].address)
