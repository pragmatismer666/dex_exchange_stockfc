...
import Token32796058 from '../tokens/Token32796058.json'
import Exchange32796058 from '../exchanges/Exchange32796058.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token32796058.abi, Token32796058.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange32796058.abi, Exchange32796058.networks[networkId].address)
