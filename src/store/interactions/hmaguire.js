...
import Token2884 from '../tokens/Token2884.json'
import Exchange2884 from '../exchanges/Exchange2884.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token2884.abi, Token2884.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange2884.abi, Exchange2884.networks[networkId].address)
