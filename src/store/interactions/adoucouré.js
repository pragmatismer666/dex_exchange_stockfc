...
import Token2144 from '../tokens/Token2144.json'
import Exchange2144 from '../exchanges/Exchange2144.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token2144.abi, Token2144.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange2144.abi, Exchange2144.networks[networkId].address)
