...
import Token1692 from '../tokens/Token1692.json'
import Exchange1692 from '../exchanges/Exchange1692.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1692.abi, Token1692.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1692.abi, Exchange1692.networks[networkId].address)
