...
import Token37259199 from '../tokens/Token37259199.json'
import Exchange37259199 from '../exchanges/Exchange37259199.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token37259199.abi, Token37259199.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange37259199.abi, Exchange37259199.networks[networkId].address)
