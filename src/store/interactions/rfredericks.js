...
import Token4371 from '../tokens/Token4371.json'
import Exchange4371 from '../exchanges/Exchange4371.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token4371.abi, Token4371.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange4371.abi, Exchange4371.networks[networkId].address)
