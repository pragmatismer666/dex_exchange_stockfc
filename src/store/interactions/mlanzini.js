...
import Token1452 from '../tokens/Token1452.json'
import Exchange1452 from '../exchanges/Exchange1452.json'
...
export const loadToken = async (web3, networkId, dispatch) => {
    try {
        const token = new web3.eth.Contract(Token1452.abi, Token1452.networks[networkId].address)
...
export const loadExchange = async (web3, networkId, dispatch) => {
    try {
        const exchange = new web3.eth.Contract(Exchange1452.abi, Exchange1452.networks[networkId].address)
